...
import qualifiedLeadsData from "../../json/qualifiedLeads.json";
...
const QualifiedLeadsPage = () => {
  ...
  useEffect(() => {
    setLeads(qualifiedLeadsData);
    setFilteredLeads(qualifiedLeadsData);
  }, []);
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Manage high-potential leads here.
          </p>
        </div>
        <button
